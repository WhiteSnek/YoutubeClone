...
const Profile = () => {
  ...
  return (
    <div className="grid grid-cols-12">
      ...
      <div className={`p-10 ${show ? "col-span-10" : "col-span-12"}`}>
        <div className="flex gap-10">
          ...
          <div className="">
            ...
            {username === user.username ? (
              <button className="bg-gray-100 px-4 py-2 mt-4 rounded-full hover:bg-gray-200 ">
                Customise Channel
              </button>
            ) : (
              <button className="bg-gray-100 px-4 py-2 mt-4 flex gap-2 justify-center rounded-full hover:bg-gray-200">
